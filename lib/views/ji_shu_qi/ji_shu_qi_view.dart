...
class JiShuQiView extends GetView<JiShuQiController> {
  ...
  /// Android / iOS 增加操作按钮的触摸高度，桌面端保持原尺寸。
  double get _platformActionButtonsHeight {
    final isMobilePlatform = !kIsWeb && (Platform.isAndroid || Platform.isIOS);
    return isMobilePlatform ? _actionButtonsHeight + 10 : _actionButtonsHeight;
  }
          ...
          (row) => TableRow(
              ...
              children: List.generate(4, (column) {
                ...
                final cellWidget = GestureDetector(
                  ...
                  onDoubleTap: valueIndex == 4 ? controller.showCurrentAmountReconcileDialog : null,
                  child: Align(
                    alignment: Alignment.center,
                    child: FittedBox(
                      fit: BoxFit.contain,
                          ...
                          style: TextStyle(
                              ...
                              color: (valueIndex == 26 || valueIndex == 27)
                                  ...
                                  : (valueIndex == 24 || valueIndex == 22)
                                      ...
                                      : valueIndex == 2 && controller.state.currentTempIndex != 0
                                          ? Colors.amber
                                          : controller.state.currentTextColor),
